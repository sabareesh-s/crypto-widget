                ...
                <div class="widget-container">
                  <div class="widget-title">
                    ...
                    <div class="widget-price">
                        ...
                        class="icon-arrow" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="${priceChange < 0 ? '#b91c1c' : '#15803d'}">
                        ...
                        <div class="price-change">
                            <p>PRICE</p>
                            <span style="color: ${priceChange < 0 ? '#b91c1c' : '#15803d'}">₹${priceChange}</span>
                        </div>
                    </div>
